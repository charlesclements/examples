package com.fatbird.assets
{
	
	
	import com.bedrock.framework.plugin.storage.HashMap;
	import com.fatbird.framework.core.dispatcher.Dispatcher;
	import com.fatbird.framework.core.dispatcher.StarlingDispatcher;
	import com.fatbird.framework.core.event.SiteEvent;
	import com.fatbird.framework.core.event.StarlingSiteEvent;
	...
	public class Assets extends EventDispatcher
	{
		...
		private static function _onLoaderComplete(event:LoaderEvent):void
		{
			...
			//Dispatcher.dispatchEvent( new SiteEvent( SiteEvent.a
			//sAssets.//.dispatchEvent( new flash.events.Event( flash.events.Event.COMPLETE ) );
			
			//dispatchEvent( new starling.events.Event( starling.events.Event.COMPLETE, false, {} ) );
