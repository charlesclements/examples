...
package org.computus.model
{
	...
	// PROPERTIES
		...
		protected var tickFrequency:int		= 50	// 1 second
		protected var tickDuration:Number	= 50	// per second
...
//trace ( "regulator accumulator = " + regulatorAcc )
			...
			//dispatchEvent( new TimerEvent( TimerEvent.
