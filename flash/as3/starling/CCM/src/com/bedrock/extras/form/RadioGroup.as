package com.bedrock.extras.form
{
	...
	public class RadioGroup extends DispatcherBase
	{
		/*
		...
		*/		
		...
		private function manageSelection():void
		{
			...
			for (var i:int = 0 ; i < numLength; i++) {
				if (i == this.selectedIndex) {
					this._getRadioButton(i).select();
				} else {
					this._getRadioButton(i).deselect();
				}
			}
		}
		...
		Get Radio Button
		*/
		private function _getRadioButton($index:uint):RadioButton
		{
