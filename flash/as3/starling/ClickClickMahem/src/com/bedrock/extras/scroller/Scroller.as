...
package com.bedrock.framework.plugin.scroller
{
	...
	public class Scroller extends DispatcherBase
	{
		/*
		...
		*/
		public function startIncrementalMovement( $increment:Number ):void
		{
			...
			this._objScrollerTrigger.startInterval( 0.01 );
		}
		/*
		...
		*/
		public function stopIncrementalMovement():void
		{
			...
			this._objScrollerTrigger.stopInterval();
		}
		...
		*/
		private function startScrubberMovement():void
		{
			...
			this._objScrollerTrigger.startInterval(0.001);
