package com.bedrock.extras.video
{
	public class YouTubePlayerEvent extends VideoEvent
	{
		...
		public static const PLAYER_READY:String = "YouTubePlayerEvent.onReady";
		public static const PLAYER_ERROR:String = "YouTubePlayerEvent.onError";
		public static const PLAYER_CHANGE:String = "YouTubePlayerEvent.onStateChange";
