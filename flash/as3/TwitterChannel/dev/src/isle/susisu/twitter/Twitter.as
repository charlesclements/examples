package isle.susisu.twitter
{
	...
	public class Twitter extends Object
	{
		...
		public function Twitter(consumerKey:String,consumerKeySecret:String,accessToken:String="",accessTokenSecret:String="")
		{
		...
		public function oauth_accessToken(verifier:String,sendImmediate:Boolean=true):TwitterRequest
		{
			...
			MonsterDebugger.trace( this, "oauth_accessToken" );
			...
			{
				MonsterDebugger.trace( this, "onComplete" );
			...
			{
				MonsterDebugger.trace( this, "onError" );
